...
class WalletServiceImplTest {
    ...
    public void registerWalletTest()  {
        try{
            ...
            Wallet wallet2 = new Wallet(2, "kumar", 100.0, "1234");
    ...
    public void ShowWalletBalanceTest()  {
        try{
            assertEquals(19010.0,walletServiceTest.showWalletBalance(1));
    ...
    public void UnRegisterWallet()  {
        try{
            ...
            assertEquals(null,walletServiceTest.unRegisterWallet(1,"123"));
            assertEquals(null,walletServiceTest.unRegisterWallet(2,"1234"));
